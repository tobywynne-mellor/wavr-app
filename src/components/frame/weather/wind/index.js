		...
		return (
            <div>
              <svg class={style.dial} viewBox='0 0 200 200'>
								<ellipse class={style.pointer}ry="80" rx="80" id="backCircle" cy="100" cx="100" stroke-width="3" stroke="#ffffff" fill="#000"/>
                ...
                <text class="foreground" fill="#ffffff" font-family="Sans-serif" font-size="18" id="speedText" stroke="#ff0000" stroke-width="0" text-anchor="middle"  x="100" y="130">{ this.props.speed } mph</text>
								<path class={style.pointer} transform='rotate({{this.props.speed}},100,100)' d="M100,20 L110,50 L90,50 z" fill="#ff0000" />
              </svg>
            </div>
		);
	}
